...
// node_modules/@chakra-ui/css-reset/dist/chunk-Q6MPIRQA.mjs
...
function animateValue({ autoplay = true, delay: delay2 = 0, driver = frameloopDriver, keyframes: keyframes$1, type = "keyframes", repeat = 0, repeatDelay = 0, repeatType = "loop", onPlay, onStop, onComplete, onUpdate, ...options }) {
  ...
  const tick = (timestamp) => {
    ...
    if (repeat) {
      const progress3 = time / resolvedDuration;
...
var createScopedAnimate = (scope) => {
  function scopedAnimate(valueOrElement, keyframes3, options) {
    let animation;
    if (isDOMKeyframes(keyframes3)) {
      animation = animateElements(valueOrElement, keyframes3, options, scope);
    } else {
      animation = animateSingleValue(valueOrElement, keyframes3, options);
    }
    if (scope) {
...
// node_modules/@chakra-ui/avatar/dist/chunk-35PPE65Y.mjs
...
// node_modules/@chakra-ui/checkbox/dist/chunk-BRNJ4EME.mjs
