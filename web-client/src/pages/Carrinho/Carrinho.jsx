            ...
            <Header />
            {
                carrinho ? (<div className='juncao'>
                    ...
                    <div className='fundoItens'>
                        ...
                        <button className='btnFinalizar' onClick={navSelectEnde}>go to checkout</button>
                    </div>
                </div>) : (<div className='carrinhovazio'>
                    <BsCartX className='empty' size={40} color='#8e1c1c' />
                    <h1 className='textempty'>your cart is empty.</h1>
                    <button className='btnadd' onClick={() => navigate("/Produtos")}>add itens to cart</button>
                </div>)
            }
