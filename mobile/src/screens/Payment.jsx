...
function Payment() {
    ...
    return (
        ...
        >
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate("PaymentCredit", {pedido: pedido, local: local})}>
                <Image
                    source={cc}
                    style={{ width: PixelRatio.getPixelSizeForLayoutSize(10), height: PixelRatio.getPixelSizeForLayoutSize(10) }}
                />
            ...
            {local == "aqui" ? (<TouchableOpacity style={styles.button}>
                <Image
                    source={caixa}
                    style={{ width: PixelRatio.getPixelSizeForLayoutSize(10), height: PixelRatio.getPixelSizeForLayoutSize(10) }}
                />
